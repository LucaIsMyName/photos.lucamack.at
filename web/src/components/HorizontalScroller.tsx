...
const HorizontalScroller = ({ children }: HorizontalScrollerProps) => {
  ...
  return (
    <div className="relative flex items-center">
      ...
      <div
        className={`absolute top-0 left-0 bottom-0 w-8 bg-gradient-to-r ${theme === 'light' ? 'from-white' : 'from-black'} to-transparent pointer-events-none transition-opacity duration-300 ${showLeftGradient ? 'opacity-100' : 'opacity-0'}`}>
        <div
      ...
      <div
        className={`absolute top-0 right-0 bottom-0 w-8 bg-gradient-to-l ${theme === 'light' ? 'from-white' : 'from-black'} to-transparent pointer-events-none transition-opacity duration-300 ${showRightGradient ? 'opacity-100' : 'opacity-0'}`}>
        <div
